    ...
    <section id="about">
      ...
      <div className="about-container">
        <div className="aligncnt">
          <img
            src="https://cdn.tasteatlas.com/images/recipes/fce63bd4b7574054a1469398a5a11135.jpg"
            alt="Cat Image"
          ></img>
          <div className="about-text">
            <p>
              ...
              Hello! My name is Tadej Tolić, and I am a music editor for Radio Študent
              based in Slovenia. I have been DJ-ing for over 10 years, and I love to
